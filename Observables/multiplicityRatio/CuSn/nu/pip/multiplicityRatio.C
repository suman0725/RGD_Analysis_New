...
void multiplicityRatio() {
    ...
    auto* h_LD2_Phi_h = new TH1F("Ph_LD2_hi_h", "LD2 Phi_h distribution;Phi_h (Degree);Counts", 100, 0, 360);
    auto* h_LD2_Pt2 = new TH1F("h_LD2_Pt2", "LD2 Pt^2 distribution;Pt^2;Counts", 100, 0, 3);
 ...
 */
    ...
    graph->SetTitle("Multiplicity Ratio vs nu;nu;R_h^A");
    ...
    canvas->SaveAs("multiplicity_ratio_nu.png");
