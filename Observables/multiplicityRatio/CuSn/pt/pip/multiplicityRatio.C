 ...
 */
    ...
    auto* h_LD2_piP = new TH1F("h_LD2_piP", "LD Hadrons;z;Counts", nBins, pt2Min, pt2Max);
    //auto* h_C_ele = new TH1F("h_C_ele", "Carbon Target Electrons;nu;Counts", nBins, zMin, zMax);
    auto* h_C_piP = new TH1F("h_C_piP", "Carbon Positive Pions;z;Counts", nBins, pt2Min, pt2Max);
   ...
   */
    ...
    TCanvas* canvas = new TCanvas("canvas", "Multiplicity Ratio vs Pt2", 800, 600);
    
    // Set graph titles and styles
    graph->SetTitle("Multiplicity Ratio vs Pt2;Pt2;R_h^A");
    ...
    canvas->SaveAs("multiplicity_ratio_Pt2.png");
