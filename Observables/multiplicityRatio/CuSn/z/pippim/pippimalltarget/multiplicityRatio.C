...
void multiplicityRatio() {
    ...
    auto* h_LD2_piP = new TH1F("h_LD2_piP", "LD Positive Pions;nu;Counts", nBins, zMin, zMax);
    auto* h_LD2_piM = new TH1F("h_LD2_piM", "LD Negative Pions;nu;Counts", nBins, zMin, zMax);
    auto* h_Cu_ele = new TH1F("h_Cu_ele", "Copper Electrons;nu;Counts", nBins, zMin, zMax);
    auto* h_Cu_piP = new TH1F("h_Cu_piP", "Copper Positive Pions;nu;Counts", nBins, zMin, zMax);
    auto* h_Cu_piM = new TH1F("h_Cu_piM", "Copper Negative Pions;nu;Counts", nBins, zMin, zMax);
    auto* h_Sn_ele = new TH1F("h_Sn_ele", "Tin Electrons;nu;Counts", nBins, zMin, zMax);
    auto* h_Sn_piP = new TH1F("h_Sn_piP", "Tin Positive Pions;nu;Counts", nBins, zMin, zMax);
    auto* h_Sn_piM = new TH1F("h_Sn_piM", "Tin Negative Pions;nu;Counts", nBins, zMin, zMax);
    // Add histograms for Carbon target (positive and negative pions)
    auto* h_Carbon_ele = new TH1F("h_Carbon_ele", "Carbon Electrons;nu;Counts", nBins, zMin, zMax);
    auto* h_Carbon_piP = new TH1F("h_Carbon_piP", "Carbon Positive Pions;nu;Counts", nBins, zMin, zMax);
    auto* h_Carbon_piM = new TH1F("h_Carbon_piM", "Carbon Negative Pions;nu;Counts", nBins, zMin, zMax);
...
TCanvas* canvas_piP = new TCanvas("canvas_multiplicity_piP", "Multiplicity Ratio vs z for Carbon, Copper, and Tin", 800, 600);
graph_multiplicity_piP_Cu->SetTitle("Multiplicity Ratio vs. z for Carbon, Copper, and Tin");
graph_multiplicity_piP_Cu->GetXaxis()->SetTitle("z");
...
// Create a canvas for the pi- graph
TCanvas* canvas_piM = new TCanvas("canvas_multiplicity_piM", "Multiplicity Ratio vs z for Carbon, Copper, and Tin", 800, 600);
graph_multiplicity_piM_Cu->SetTitle("Multiplicity Ratio vs. z for Carbon, Copper, and Tin");
graph_multiplicity_piM_Cu->GetXaxis()->SetTitle("z");
