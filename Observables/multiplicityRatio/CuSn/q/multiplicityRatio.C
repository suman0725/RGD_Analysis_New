 ...
 */
    ...
    auto* h_LD2_piP = new TH1F("h_LD2_piP", "LD Hadrons;nu;Counts", nBins, q2Min, q2Max);
    auto* h_C_ele = new TH1F("h_C_ele", "Carbon Target Electrons;nu;Counts", nBins, q2Min, q2Max);
 ...
 */
    ...
    TCanvas* canvas = new TCanvas("canvas", "Multiplicity Ratio vs Q2", 800, 600);
    
    // Set graph titles and styles
    graph->SetTitle("Multiplicity Ratio vs Q2;Q2;R_h^A");
    ...
    canvas->SaveAs("multiplicity_ratio_Q2.png");
