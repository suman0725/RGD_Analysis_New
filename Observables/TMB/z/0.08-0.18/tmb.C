 ...
 */
    ...
    auto* h_LD2_pT2 = new TH1F("h_LD2_Pt2", "LD2 Pt^2 distribution;Pt^2;Counts", 100, 0, 1);
    ...
    for (int i = 1; i <= h_LD2_pT2_average->GetNbinsX(); ++i) {
        ...
        cout << "Average p_T^2_A: " << average_pT2 << " [GeV^2]" << std::endl;
        cout << "Error_A" << error_D << endl; 
    ...
    cout << "Average p_T^2_A: " << average_pT2_A << " [GeV^2]" << std::endl;
 ...
 */
    ...
    c1->SaveAs("pT2_histogram_C.png"); // Save the histogram as an image file
