...
void tmb() {
    // Define the z ranges and corresponding deltaPt2 values and errors
    double zRanges[] = {0.13, 0.23, 0.33, 0.43, 0.53, 0.63, 0.73, 0.83, 0.93}; // Midpoints of the z ranges
    ...
    graph->SetTitle("#DeltaP_{T}^{2} vs z; z; #DeltaP_{T}^{2}");
