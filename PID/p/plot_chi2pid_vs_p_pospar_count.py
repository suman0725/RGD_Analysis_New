...
latex.DrawLatex(0.15, 0.85, f"Positive pions (pid=211): {positive_pion_count}")
latex.DrawLatex(0.15, 0.80, f"Kaons (pid=321): {kaon_count}")

# Save the plot
canvas.SaveAs("chi2pid_vs_p_with_counts.png")
