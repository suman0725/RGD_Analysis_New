...
int main() {
    ...
    // Access the trees
    TTree* tree1 = dynamic_cast<TTree*>(file1->Get("kaon"));
    TTree* tree2 = dynamic_cast<TTree*>(file2->Get("kaon"));
    if (!tree1 || !tree2) {
    ...
    TString pdf_file = "delta_t_comparison_legend_kaon.pdf";
    ...
    for (int i = 0; i < num_slices; i++) {
        ...
        hist_with_pid->SetFillColorAlpha(kBlue, 0.5); // Semi-transparent red
