...
int main() {
    ...
    TH1F* h1_deltaT_pion_positive_wpid = new TH1F("h1_deltaT_pion_positive_wpid", "+ve pions); #DeltaT (ns); Counts", 100, -5, 5);
    TH1F* h1_deltaT_pion_positive_wopid = new TH1F("h1_deltaT_pion_positive_wopid", "+ve pions; #DeltaT (ns); Counts", 100, -5, 5);
    TH1F* h1_deltaT_kaon_positive_wpid = new TH1F("h1_deltaT_kaon_positive_wpid", "+ve kaons; #DeltaT (ns); Counts", 100, -5, 5);
    TH1F* h1_deltaT_kaon_positive_wopid = new TH1F("h1_deltaT_kaon_positive_wopid", "+ve kaons; #DeltaT (ns); Counts", 100, -5, 5);
   ...
   leg1->SetTextSize(0.02); 
    ...
    c1->SaveAs("deltaT_comparison_018536.pdf");
    ...
    // Save the canvas
    c3->SaveAs("deltaT_comparison_018536_deuteron.pdf");
