...
void plotBetaMTNormalizeLow() {
    ...
    canvas->Print("beta_histograms_mt_normalize_cherenkov.pdf[");
    ...
    timer.Stop();
    cout << "Histograms saved to beta_histogram_mt_normalize_cherenkov.pdf" << endl;
