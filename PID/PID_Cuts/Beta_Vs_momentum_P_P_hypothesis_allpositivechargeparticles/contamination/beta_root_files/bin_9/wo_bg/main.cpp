...
int main() {
    ...
    Double_t initParams[19] = {
        amp_pi, beta_pi_theory, 0.003, 2.0, 3.0, 2.0, 3.0, // Pion peak 
        amp_K, beta_K_theory, 0.0025, 1.0, 2.0,          //kaon peak           
        amp_p, beta_p_theory, 0.003, 1.0, 2.0, 1.5, 2.0   //proton peak 
    };
    ...
    totalCB->SetParLimits(5, 0.1, 10.0); totalCB->SetParLimits(6, 1.0, 20.0);
