...
int main() {
    ...
    // Pion
    totalCB->SetParLimits(0, 0, 25000); totalCB->FixParameter(1, beta_pi_theory); totalCB->SetParLimits(2, 0.002, 0.004);
    ...
    // Kaon
    totalCB->SetParLimits(7, 0, 6000); totalCB->SetParameter(8, beta_K_theory); totalCB->SetParLimits(9, 0.0025, 0.004);
