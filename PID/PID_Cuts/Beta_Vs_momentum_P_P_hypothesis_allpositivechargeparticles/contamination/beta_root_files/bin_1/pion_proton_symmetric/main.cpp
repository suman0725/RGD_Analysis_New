...
int main() {
    ...
    Double_t initParams[10] = {
        ...
        amp_K, beta_K_theory, 0.003, 1.0, 2.0           // Kaon (amp, mean, sigma, alpha, n)
    };
    ...
    // Pion
    totalCB->SetParLimits(0, 0, 165000); totalCB->SetParameter(1, beta_pi_theory); totalCB->SetParLimits(2, 0.002, 0.004);
    totalCB->SetParLimits(3, 0.1, 10.0); totalCB->SetParLimits(4, 1.0, 20.0);
    // Kaon
    totalCB->SetParLimits(5, 0, 12000); totalCB->SetParameter(6, beta_K_theory); totalCB->SetParLimits(7, 0.0025, 0.005);
