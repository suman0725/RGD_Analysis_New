...
int main() {
    ...
    // Pion
    totalCB->SetParLimits(0, 0, 37000); totalCB->FixParameter(1, beta_pi_theory); totalCB->SetParLimits(2, 0.002, 0.00);
    ...
    // Kaon
    totalCB->SetParLimits(7, 0, 8000); totalCB->FixParameter(8, beta_K_theory); totalCB->SetParLimits(9, 0.0025, 0.004);
    totalCB->SetParLimits(10, 0.1, 20.0); totalCB->SetParLimits(11, 1.0, 100.0);

    // Proton
    totalCB->SetParLimits(12, 0, 20000); totalCB->SetParameter(13, beta_p_theory); totalCB->SetParLimits(14, 0.001, 0.006);
    ...
    double kaonIntegral = cb_kaon->Integral(0.9594, 1.03); // Adjusted for bin 3.4-3.7
    double protonIntegral = cb_proton->Integral(0.9587, 1.03); // Adjusted for bin 3.4-3.7
    ...
    if (outFile.is_open()) {
        ...
        outFile << "Proton Contamination (Proton Integral [0.9587, 1.03] / Pion Integral [0.95, 1.03]): " << fixed << setprecision(3) << protonContamination << "%\n";
        outFile.close();
    } else {
