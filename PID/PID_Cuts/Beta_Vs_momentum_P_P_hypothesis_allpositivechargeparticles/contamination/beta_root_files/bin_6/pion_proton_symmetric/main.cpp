...
int main() {
    ...
    // Pion
    totalCB->SetParLimits(0, 0, 36000); totalCB->SetParameter(1, beta_pi_theory); totalCB->SetParLimits(2, 0.002, 0.004);
    totalCB->SetParLimits(3, 0.1, 10.0); totalCB->SetParLimits(4, 1.0, 20.0);
    // Kaon
    totalCB->SetParLimits(5, 0, 8000); totalCB->SetParameter(6, beta_K_theory); totalCB->SetParLimits(7, 0.0025, 0.004);
    totalCB->SetParLimits(8, 0.1, 20.0); totalCB->SetParLimits(9, 1.0, 10.0);
    // Proton
    totalCB->SetParLimits(10, 0, 20000); totalCB->SetParameter(11, beta_p_theory); totalCB->SetParLimits(12, 0.002, 0.006);
