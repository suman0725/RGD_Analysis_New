...
int main() {
    ...
    ROOT::RDF::TH1DModel modelBeta("beta_fit_cb", "p: [5.2-5.5) GeV/c; #beta; Counts", 200, 0.95, 1.03);
    ...
    // Pion
    totalCB->SetParLimits(0, 0, 4000); totalCB->SetParameter(1, beta_pi_theory); totalCB->SetParLimits(2, 0.002, 0.006);
    totalCB->SetParLimits(3, 0.1, 10.0); totalCB->SetParLimits(4, 1.0, 20.0);
    // Kaon
    totalCB->SetParLimits(5, 0, 600); totalCB->SetParameter(6, beta_K_theory); totalCB->SetParLimits(7, 0.002, 0.003);
    totalCB->SetParLimits(8, 0.1, 20.0); totalCB->SetParLimits(9, 1.0, 10.0);
    // Proton
    totalCB->SetParLimits(10, 0, 1200); totalCB->SetParameter(11, beta_p_theory); totalCB->SetParLimits(12, 0.002, 0.006);
