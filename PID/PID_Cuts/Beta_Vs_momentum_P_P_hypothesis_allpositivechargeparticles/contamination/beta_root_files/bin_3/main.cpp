...
int main() {
    ...
    // Pion
    totalCB->SetParLimits(0, 0, 180000); totalCB->SetParameter(1, beta_pi_theory); totalCB->SetParLimits(2, 0.002, 0.006);
    ...
    // Kaon
    totalCB->SetParLimits(7, 0, 20000); totalCB->SetParameter(8, beta_K_theory); totalCB->SetParLimits(9, 0.0025, 0.006);
    totalCB->SetParLimits(10, 0.1, 20.0); totalCB->SetParLimits(11, 1.0, 100.0);

    // Background
    totalCB->SetParLimits(12, 0, 1000); totalCB->SetParLimits(13, -100, 100);
