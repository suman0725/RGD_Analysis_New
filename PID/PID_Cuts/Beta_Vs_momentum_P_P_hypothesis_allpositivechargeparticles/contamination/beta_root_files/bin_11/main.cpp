...
int main() {
    ...
    // Pion
    totalCB->SetParLimits(0, 0, 12000); totalCB->FixParameter(1, beta_pi_theory); totalCB->SetParLimits(2, 0.002, 0.006);
    ...
    // Kaon
    totalCB->SetParLimits(7, 0, 4500); totalCB->FixParameter(8, beta_K_theory); totalCB->SetParLimits(9, 0.0025, 0.003);
    totalCB->SetParLimits(10, 0.1, 20.0); totalCB->SetParLimits(11, 1.0, 100.0);

    // Proton
    totalCB->SetParLimits(12, 0, 4000); totalCB->SetParameter(13, beta_p_theory); totalCB->SetParLimits(14, 0.002, 0.004);
