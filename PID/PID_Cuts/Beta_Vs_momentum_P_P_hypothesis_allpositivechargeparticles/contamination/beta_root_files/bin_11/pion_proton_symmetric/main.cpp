...
int main() {
    ...
    ROOT::RDF::TH1DModel modelBeta("beta_fit_cb", "p: [4.3-4.6) GeV/c; #beta; Counts", 200, 0.95, 1.03);
    ...
    // Kaon
    totalCB->SetParLimits(5, 0, 3000); totalCB->SetParameter(6, beta_K_theory); totalCB->SetParLimits(7, 0.002, 0.003);
    totalCB->SetParLimits(8, 0.1, 20.0); totalCB->SetParLimits(9, 1.0, 10.0);
    // Proton
    totalCB->SetParLimits(10, 0, 4000); totalCB->SetParameter(11, beta_p_theory); totalCB->SetParLimits(12, 0.002, 0.004);
