...
int main() {
    ...
    ROOT::RDF::TH1DModel modelBeta("beta_fit_cb", "p: [4.9-5.2) GeV/c; #beta; Counts", 200, 0.95, 1.03);
    ...
    // Kaon
    totalCB->SetParLimits(5, 0, 25000); totalCB->SetParameter(6, beta_K_theory); totalCB->SetParLimits(7, 0.002, 0.003);
