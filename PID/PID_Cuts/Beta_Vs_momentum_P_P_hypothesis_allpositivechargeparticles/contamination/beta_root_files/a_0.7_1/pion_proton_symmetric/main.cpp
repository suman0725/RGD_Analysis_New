...
int main() {
 ...
 ROOT::RDataFrame df_all("EB_all_pion_assumed", file);
    ...
    ROOT::RDF::TH1DModel modelBeta("beta_fit_cb", "p: [0.7-1.0) GeV/c; #beta; Counts", 200, 0.95, 1.03);
    ...
    Double_t initParams[5] = {
        amp_pi, beta_pi_theory, 0.005, 1.5, 2.0          // Pion (amp, mean, sigma, alphaRight, nRight)
    };
    ...
    // Pion
    totalCB->SetParLimits(0, 0, 190000); totalCB->SetParameter(1, beta_pi_theory); totalCB->SetParLimits(2, 0.003, 0.01);
    totalCB->SetParLimits(3, 0.1, 20.0); totalCB->SetParLimits(4, 1.0, 100.0);
