...
int main() {
    ...
    Double_t initParams[15] = {
        ...
        amp_p, beta_p_theory, 0.004, 2.0, 3.0            // Proton (amp, mean, sigma, alphaRight, nRight)
    };
    ...
    // Pion
    totalCB->SetParLimits(0, 0, 50000); totalCB->SetParameter(1, beta_pi_theory); totalCB->SetParLimits(2, 0.002, 0.004);
    ...
    // Proton
    totalCB->SetParLimits(10, 0, 30000); totalCB->SetParameter(11, beta_p_theory); totalCB->SetParLimits(12, 0.002, 0.006);
