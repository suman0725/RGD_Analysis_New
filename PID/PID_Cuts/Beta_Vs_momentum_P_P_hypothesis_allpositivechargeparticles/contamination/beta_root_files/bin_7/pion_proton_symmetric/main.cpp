...
int main() {
    ...
    // Pion
    totalCB->SetParLimits(0, 0, 26000); totalCB->SetParameter(1, beta_pi_theory); totalCB->SetParLimits(2, 0.002, 0.004);
    ...
    // Proton
    totalCB->SetParLimits(10, 0, 15000); totalCB->SetParameter(11, beta_p_theory); totalCB->SetParLimits(12, 0.002, 0.006);
