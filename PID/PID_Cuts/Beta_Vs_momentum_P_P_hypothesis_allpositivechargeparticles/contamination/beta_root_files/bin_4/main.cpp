...
int main() {
    ...
    // Pion
    totalCB->SetParLimits(0, 0, 65000); totalCB->SetParameter(1, beta_pi_theory); totalCB->SetParLimits(2, 0.002, 0.006);
    ...
    // Kaon
    totalCB->SetParLimits(7, 0, 10000); totalCB->SetParameter(8, beta_K_theory); totalCB->SetParLimits(9, 0.0025, 0.006);
