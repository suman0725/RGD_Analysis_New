...
pair<double, double> getKaonFitRange(double pMid) {
    if (pMid >= 4.0 && pMid < 4.3) return {0.991, 0.994};   // 4.0-4.3 GeV/c
    ...
    if (pMid >= 5.2 && pMid < 5.5) return {0.993, 0.998};   // 5.2-5.5 GeV/c
    if (pMid >= 5.5 && pMid < 5.8) return {0.994, 0.998};   // 5.5-5.8 GeV/c
    if (pMid >= 5.8 && pMid < 6.1) return {0.994, 0.998};   // 5.8-6.1 GeV/c
    if (pMid >= 6.1 && pMid < 6.4) return {0.994, 0.998};   // 6.1-6.4 GeV/c
    if (pMid >= 6.4 && pMid < 6.7) return {0.995, 0.998};  // 6.4-6.7 GeV/c
    if (pMid >= 6.7 && pMid < 7.0) return {0.995, 0.998};   // 6.7-7.0 GeV/c
...
pair<double, double> getPionFitRange(double pMid) {
    if (pMid >= 4.0 && pMid < 4.3) return {0.9968, 1.015};    // 4.0-4.3 GeV/c
...
pair<double, double> getIntersectionRange(double pMid) {
    if (pMid >= 4.0 && pMid < 4.3) return {0.9938, 0.995};   // Adjusted to match visual crossover
    ...
    if (pMid >= 6.7 && pMid < 7.0) return {0.995, 0.998};   // Adjust based on visual inspection
...
double findIntersection(TF1* f1, TF1* f2, double pMid, double tolerance = 1e-6) {
    ...
    double stepSize = (xMaxIntersect - xMinIntersect) / 1000.0;
